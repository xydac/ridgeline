...
func TestRunStatus_UnknownConnectorType_EnumeratesKnown(t *testing.T) {
	t.Parallel()
	dir := t.TempDir()
	cfgPath := filepath.Join(dir, "ridgeline.yaml")
	cfg := `
...
func TestRunStatus_UnknownSinkType_Rejected(t *testing.T) {
	t.Parallel()
	dir := t.TempDir()
	cfgPath := filepath.Join(dir, "ridgeline.yaml")
	cfg := `
...
func TestRunStatus_UnknownEnricherType_Rejected(t *testing.T) {
	t.Parallel()
	dir := t.TempDir()
	cfgPath := filepath.Join(dir, "ridgeline.yaml")
	cfg := `
